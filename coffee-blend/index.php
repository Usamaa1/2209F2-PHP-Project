    	...
    	<div class="container-wrap">
    		<div class="wrap d-md-flex align-items-xl-end">
	    		...
	    		<div class="book p-4">
		            ...
		            <div class="form-group ml-md-4">
		              <input type="submit" name="book" value="Appointment" class="btn btn-white py-3 px-4">
		            </div>
	    				</div>
	    			</form>
	    		</div>
...
<?php foreach($product_fetch as $data){ ?>
        	...
        	<div class="col-md-3">
        		<div class="menu-entry">
    					...
    					<div class="text text-center pt-4">
    						...
    						<p><a href="product-single.php?prodId=<?php echo $data['prod_id'] ?>" class="btn btn-primary btn-outline-primary">Show</a></p>
    					</div>
    				</div>
        	</div>
